      ...
      <div className="hidden md:flex items-start justify-between relative">
        ...
        {steps.map((step, index) => (
          <motion.div
            ...
            transition={{ duration: 0.5, delay: prefersReducedMotion ? 0 : 0.3 + index * 0.2 }}
          ...
          >
            ...
            <div className="w-16 h-16 rounded-full bg-surface border border-primary/30 flex items-center justify-center text-primary mb-4">
              {iconSvgs[step.icon] || <span className="text-xl font-bold">{step.number}</span>}
            </div>
      ...
      <div className="md:hidden relative">
        ...
        {steps.map((step, index) => (
          <motion.div
            ...
            transition={{ duration: 0.5, delay: prefersReducedMotion ? 0 : 0.2 + index * 0.2 }}
